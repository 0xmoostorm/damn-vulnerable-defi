...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
        ...
        this.rewarderAttacker = await RewarderAttackerFactory.deploy(this.rewarderPool.address, this.flashLoanPool.address, this.liquidityToken.address, this.rewardToken.address);

        // console.log(this.rewarderAttacker);
        this.rewarderAttacker.attack();

        // rewardAttacker = await  this.rewardAttacker.connect(attacker);

        // await this.rewardAttacker.attack()
